          ...
          postSubscribeObj('subscribe', subscription,
            function(response) {
              ...
              if (response.status === 201) {
                ...
                subBtn.innerHTML = '<i class="fa-solid fa-bell  d-flex justify-content-end hvr-pulse small-icon text-white mt-3"></i>';
                subBtn.disabled = false;
                isPushEnabled = true;
          ...
          function(response) {
            ...
            if (response.status === 202) {
              ...
              subscription.unsubscribe()
                .then(
                  function(successful) {
                    subBtn.innerHTML = '<i class="fa-solid fa-bell-slash  d-flex justify-content-end hvr-pulse small-icon text-white mt-3"></i>';
